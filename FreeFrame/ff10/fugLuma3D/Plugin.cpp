...
ffPlugin::ffPlugin( ParamConstantsStruct *Parameters, DWORD Count ) : FreeFramePlugin( Parameters, Count )
{
	...
	char ID[5] = "BF02";		 // this *must* be unique to your plugin 
								 // see www.freeframe.org for a list of ID's already taken
	char name[17] = "fugLuma3D";
	...
	plugExtInfo.PluginMinorVersion = 4;

	plugExtInfo.Description = "Luma3D";
	plugExtInfo.About = "(c)2004-2007 Alex May - www.bigfug.com";
