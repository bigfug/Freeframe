...
ffPlugin::ffPlugin( ParamConstantsStruct *Parameters, DWORD Count ) : FreeFramePlugin( Parameters, Count )
{
	...
	char ID[5] = "BF09";		 // this *must* be unique to your plugin 
								 // see www.freeframe.org for a list of ID's already taken
	char name[17] = "fugRGBMixer";
	...
	plugExtInfo.Description = "RGBMixer";
	plugExtInfo.About = "(c)2005 Alex May - www.bigfug.com";
